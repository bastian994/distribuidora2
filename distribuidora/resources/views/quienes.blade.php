...
<div class="top-main" id="home">
   <div class="header-top">
				<div class="w3l_header_left">
					<ul>
						<li><span class="fa fa-envelope" aria-hidden="true"></span> <a href="mailto:contacto@distribuidorajsh.com">contacto@distribuidorajsh.com</a></li>
						<li><span class="fa fa-phone-square" aria-hidden="true"></span> (+56) 9 8811 0038</li>
					</ul>
				</div>
			...
			<nav class="navbar navbar-default">
				...
				<div class="navbar-header">
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo">
						<h1><a class="navbar-brand" href="index"><span class="one">J</span>aime<span class="one">S</span>epulveda e <span class="one">H</span>ijos</a></h1>
					</div>
				</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="cl-effect-1" id="cl-effect-1">
						<ul class="nav navbar-nav">
							<li class="active"><a class="scroll" href="index">Inicio</a></li>
							<li><a href="productos" class="navbar-brand">Productos</a></li>
							<li><a href="quienes" class="scroll hvr-bounce-to-bottom">Quienes Somos</a></li>
							<li><a href="contacto" class="scroll hvr-bounce-to-bottom">Contacto</a></li>
						</ul>
					</nav>
				</div>
				<!-- /.navbar-collapse -->
...
<div class="contact-w3ls" id="contact">
		<div class="container">
			<h3 class="text-center follow">Sigue<span>nos</span></h3>
				...
				<div class="w3agile_footer_copy">
				    <p>© 2017 Jaime Sepulveda e Hijos Ltda. All rights reserved | Design by JSH</p>
			</div>
     	</div>
